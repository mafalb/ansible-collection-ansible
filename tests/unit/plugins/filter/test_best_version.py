...
TEST_CASES = (
    ...
    (['_ansible~=2.12.0'], '2.12.1'),
    (['_ansible==2.12'], '2.12.1'),
    (['_ansible==2.9'], '2.9.27'),
    (['_ansible==2.11.8'], '2.11.8'),
    (['_ansible==2.11.6'], '2.11.6'),
    (['_ansible==2.11.5'], '2.11.5'),
    (['_ansible<2.11.6'], '2.11.5'),
    (['_ansible~=2.9.6'], '2.9.27'),
    (['_ansible'], '2.12.1'),
    (['_ansible~=2.11.6', '_ansible_test'], '2.11.7'),
    (['ansible', '_ansible==2.11', '_ansible_test'], '2.11.7'),
)

T_WITH_PYTHON = (
    (['_ansible==2.12.0rc1'], '3.6', '2.12.0rc1'),
    (['_ansible~=2.12.0'], '3.8', '2.12.1'),
    (['_ansible==2.12'], '3.8', '2.12.1'),
    ...
    (['_ansible'], '3.8', '2.12.1'),
    (['_ansible'], '3.7', '2.11.7'),
    (['_ansible~=2.11.6', '_ansible_test'], '3.8', '2.11.7'),
)

...
TEST_CASES = (
    (['_ansible'], data['latest_version'][last_ansible_version_by_python[this_python]]),
)

T_WITH_PYTHON = (
    (['_ansible~=2.11.6', '_ansible_test'], '3.9', data['latest_version']['2.11']),
    (['ansible', '_ansible==2.11', '_ansible_test'], '3.9',
     data['latest_version']['2.11']),
    (['_ansible==2.12.0rc1'], '3.9', '2.12.0rc1'),
    (['_ansible~=2.12.0'], '3.9', data['latest_version']['2.12']),
    (['_ansible==2.12'], '3.9', data['latest_version']['2.12']),
    ...
    (['_ansible~=2.12.0'], '3.8', data['latest_version']['2.12']),
    (['_ansible==2.12'], '3.8', data['latest_version']['2.12']),
    ...
    (['_ansible'], '3.8', data['latest_version']['2.13']),
